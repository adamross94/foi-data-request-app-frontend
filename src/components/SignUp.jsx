...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://foi-data-app-frontend-a3384cca308e.herokuapp.com/signup', form);
      
      if (response.status === 201) {
        // After sign-up, automatically sign in the user
        const signInResponse = await axios.post('https://foi-data-app-frontend-a3384cca308e.herokuapp.com/signin', {
